...
(defn create-line-numbers-components []
  (let [parts (atom nil)
    ...
    (.setEditorKit tp (new-clojure-editor-kit))
...
(defn show-ecosystem-window [cfg] (let [
  ...
  manager (new javax.swing.undo.UndoManager)
  file-chooser (new javax.swing.JFileChooser (. System getProperty "user.dir"))
        ...
        configure-document-settings (fn[area]
    ...
    (let [app (get-mutable :ecosystem)]
      ...
      (configure-document-settings area)
      (doto frame
